...
public class DashboardUser {
    ...
    }public void handleProduits(ActionEvent event) {
        try {
            // Charger la scène des produits
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/path/to/ProductPage.fxml"));
            AnchorPane productPage = loader.load();

            // Créer une nouvelle scène avec la page produit
